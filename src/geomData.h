...
int getGradLinesInPlane1(double, dataCube, dataRun, dataRC, const double *, char *);
int getGradVectorsInPlane(double, dataCube, dataRun, dataRC, const double *, char *);
int getStreamLinesInPlane(double, dataCube, dataRun, dataRC, const double *, char *);
...
int getStreamLine(int, int, int, double, dataCube, dataRun, dataRC, const double *,
