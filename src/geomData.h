...
int getFieldInLine(double, dataCube, dataRun, dataRC, const double *, char *);

int getFieldInPlane(double, dataCube, dataRun, dataRC, const double *, char *);

int getGradLinesInPlane1(double, dataCube, dataRun, dataRC, const double *,
                         char *);
int getGradVectorsInPlane(double, dataCube, dataRun, dataRC, const double *,
                          char *);
int getStreamLinesInPlane(double, dataCube, dataRun, dataRC, const double *,
                          char *);
...
int getStreamLine(int, int, int, double, dataCube, dataRun, dataRC,
                  const double *, const double *, double[4][3], double[2],
                  double[2], dataSLine *, FILE *, FILE *);
