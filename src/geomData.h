...
#include "mathTools.h"
  ...
  int getStreamLine(int, int, int, double, dataCube, dataRun, const double*, const double*, double[4][3],
                    double[2], double[2], dataSLine*, FILE*, FILE*);
  ...
  void trans3Dto2D(double[3], double[3], double[3], double, double, double*, double*);

  void trans2Dto3D(double, double, double[4][3],double[3]);

  double RungeKutta4(double[3], double[3], dataCube, dataRun, const double*, const double*, double, int);
  double RungeKutta4_fast(double[3], double[3], dataCube, dataRun, const double*, const double*, double, int);
  double EulerMethod(double[3], double[3], dataCube, dataRun, const double*, const double*, double, int);
