...
#pragma omp for schedule (dynamic)
  for( idxGlobal = 0; idxGlobal < npt; idxGlobal++){
    ...
    tmp = campoNoPer(x,y,z,index,vecn,param,cube.hvec,cube.field,matU,gfunc,cube.min);
...
#pragma omp for schedule (dynamic)
  for( idxGlobal = 0; idxGlobal < npt; idxGlobal++){
    ...
    field2[idxGlobal] = campoPer(index,vecn,p,cube.hvec,cube.field,matU,fpol,gfunc);
  }
...
int NCIPer   (int *index,int *vecn, dataRun param,
   ...
   switch( param.pol ){
     ...
     case 3: gradPol03(h[0],h[1],h[2],f,val); break;
     case 4: gradPol04(h[0],h[1],h[2],f,val); break;
     case 5: gradPol05(h[0],h[1],h[2],f,val); break;
     case 6: gradPol06(h[0],h[1],h[2],f,val); break;
   }
  ...
  if ( tmp < param.la2 )
    if( rgd < param.rgd ){
      switch( param.pol ){
        case 1: hessPol01(h[0],h[1],h[2],f,val); break;
        case 2: hessPol02(h[0],h[1],h[2],f,val); break;
        case 3: hessPol03(h[0],h[1],h[2],f,val); break;
        case 4: hessPol04(h[0],h[1],h[2],f,val); break;
        case 5: hessPol05(h[0],h[1],h[2],f,val); break;
        case 6: hessPol06(h[0],h[1],h[2],f,val); break;
      }
...
int NCINoPer ( double x, double y, double z, int *index,
               ...
               double *field,const double *matU,
               double *min,double *ret) {
