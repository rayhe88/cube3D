...
int loadLocalField(int *index, dataCube cube, dataRun param, double *xx,
                   double *yy, double *zz, double *f) {
    ...
    if (param.pbc == NOT) {
        // In this part  the field is load for evaluating the lagrange
        // interpolators without boundary conditions periodic
        ...
        // In this part  the field is load for evaluating the lagrange
        // interpolators with boundary conditions periodic
        i = index[0];
        j = index[1];
        k = index[2];
