...
int getData(double x, int n, int pol, double *xcon, double *fun, double *xpol,
            double *fpol) {
...
int getLagParameters(double x0, double *xcon, double *xxmu, double *delta,
                     int n) {
...
int gradient3D(double x0, double y0, double z0, double *xcon, double *ycon,
               double *zcon, double *fun, int n, int trans, const double *matU,
               double *val) {
    int index;
    int m = n + 1;
    int i, j, k;
...
int getDerivatives3D(double x0, double y0, double z0, double *xcon,
                     double *ycon, double *zcon, double *fun, int n, int trans,
                     const double *matU, double *val) {
    int index;
    int m = n + 1;
    int i, j, k;
    double l0x[n + 1], l0y[n + 1], l0z[n + 1];
...
int gradient3DLog(double x0, double y0, double z0, double *xcon, double *ycon,
                  double *zcon, double *fun, int n, int trans,
                  const double *matU, double min, double *val) {
    int index;
    int m = n + 1;
    int i, j, k;
    double l0x[n + 1], l0y[n + 1], l0z[n + 1];
...
int getDerivatives3DLog(double x0, double y0, double z0, double *xcon,
                        double *ycon, double *zcon, double *fun, int n,
                        int trans, const double *matU, double min,
                        double *val) {
    int index;
    int m = n + 1;
    int i, j, k;
