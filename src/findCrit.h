...
int rejectCube(double *, double, dataCube, const double *, dataRun, double *,
               double *, double *, double *, double *, double *);

int refineCrit(int, double, dataCube, dataRun, double *, const double *,
               char *);
int describeCrit(int, double, dataCube, dataRun, double *, const double *,
                 char *);
